...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex items-center font-mono space-x-1 h-8 px-2 whitespace-nowrap border-neutral-200 bg-transparent text-xs ring-offset-white placeholder:text-neutral-500 focus:outline-none focus:ring-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-300 hover:bg-neutral-100 hover:rounded-lg",
      className,
    )}
    {...props}
  >
